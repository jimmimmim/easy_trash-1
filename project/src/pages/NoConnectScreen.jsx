    ...
    <View style={layout.backgroundContainerMain}>
      <ImageBackground source={require('../styles/greengradient.png')} resizeMode="cover" style={layout.image}>
        ...
        <View style={layout.searchContainer}>
          ...
          <Text style={[text.text_yellow, {fontSize: 20, lineHeight: 30}]}>카카오 계정 연결 없이 사용하면{"\n"}이후 결제와 데이터 저장이 되지 않습니다.</Text>
          <Text style={[text.text_yellow, {fontSize: 20, lineHeight: 30}]}>마이페이지에서 언제든지 연동할 수 있습니다.</Text>
