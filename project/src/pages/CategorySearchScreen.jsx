...
export default class CategorySearchScreen extends Component {
    ...
    return (
      <View style={layout.backgroundContainerMain}>
        ...
        <View style={layout.twoButtonContainer}>
            <TouchableOpacity onPress={() => this.props.navigation.navigate('BigTrashScreen')} style={button.buttonBox_yellow}>
        ...
        <View style={layout.searchContainer}>
          <TextInput
            ...
            placeholder="검색어 입력"
          />
          <TouchableOpacity onPressIn={this.readText} onPress={() => {this.props.navigation.navigate('PriceSearchResultScreen', {value: this.state.text})}} style={button.buttonBox_yellow}>
